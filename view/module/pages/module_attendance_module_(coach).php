<div id="" class="col-md-12">
	...
	<div class="row">
		...
		<div class="custom_breadcrumb col-md-12">
			<div class="">
				<nav class="">
					...
					<span class="custom_breadcrumb-item active">Attendance Module (Coach)</span>
				</nav>
			</div>
			<div class="title">
				Attendance Module (Coach)
			</div>
		</div>
		...
		<div class="">
			...
			<div class="row">
				<?php include 'module/portlet/module_attendance_module_(coach).html'; ?>
			</div>
