<div id="" class="col-md-12">
	...
	<div class="row">
		...
		<div class="custom_breadcrumb col-md-12">
			<div class="">
				<nav class="">
					...
					<span class="custom_breadcrumb-item"><a href="module_client.php">Client</a></span>
					<span><i class="fa fa-angle-right breadcrumb_divider" aria-hidden="true"></i></span>
					<span class="custom_breadcrumb-item active">Client Registration</span>
				</nav>
			</div>
			<div class="title">
				Client Registration
		...
		<div class="">
			...
			<div class="row">
				<?php include 'module/portlet/module_client_registration.html'; ?>
			</div>
