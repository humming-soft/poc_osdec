<div id="" class="col-md-12">
	...
	<div class="row">
		...
		<div class="custom_breadcrumb col-md-12">
			<div class="">
				<nav class="">
					...
					<span class="custom_breadcrumb-item active">Assessment</span>
				</nav>
			</div>
			<div class="title">
				Assessment
		...
		<div class="">
			...
			<?php include 'module/portlet/portlet_index_assessment.html'; ?>
...
<script type="text/javascript" src="../assets/js/pages/module_assessment.js"></script>